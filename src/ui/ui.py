...
class UI(object):
    ...
    def setup_ui(self, form):
        ...
        #Dividing line below the original image
    ...
    def retranslate_ui(self, form):
        ...
        self.label_raw_pic.setText(_translate("Form", "Please load an image"))
        ...
        self.label_bar.setText(_translate("Form", "probablistic histogram"))
